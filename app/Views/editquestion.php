...
<section class="home">
  ...
  <div class="form-group">
    <div class="input-group">         
        <select class="custom-select form-select custom-select-sm" class="custom-select custom-select-sm" aria-label="Default select example" name="answer" value="<?php echo $info_details; ?>"  id="answer_data">
    ...
    <div id="answerother_open" style="display:none;">
        ...
        <div class="form-group">
          <div class="input-group">         
            ...
            <?php foreach($answercollection as $key => $answerlist) { ?> 
                <option value="<?php echo $answerlist; ?>" <?php if(!empty($other_option) && in_array( $answerlist, $other_option)) {?> selected="selected" <?php } ?>><?php echo $answerlist; ?></option>
              <?php  } ?>
            </select>
          </div>
        </div>  
        <!-- <div class="text-left m-2 "><a class="btn btn-primary float-start" href="<?php echo site_url('answerList'); ?>">Add more Answer</a></div> -->
  ...
  <div class="form-group">
    <div class="input-group">         
        ...
        <option value="">-select-</option>
            <option value="1" <?php echo ($priority =='1')?" selected=' selected'":""?>>Range 0-6 Rating</option>
            <option value="2" <?php echo ($priority =='2')?" selected=' selected'":""?>>Range 7-8 Rating</option>
            <option value="3" <?php echo ($priority =='3')?" selected=' selected'":""?>>Range 9-10 Rating</option>
        </select>
