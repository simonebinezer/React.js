    ...
    <div class="container">
        <div class="row">
            <style>
                ...
                .select-campaign-menu button:hover {
                    /* background: #0a2472; */
                    font-size: 15px;
                    color: #000;
                    border: 0px;
                ...
                /* .select-campaign-menu button:focus {
                    background: #0a2472;
                    font-size: 15px;
                    color: #fff;
                    border: 0px;
                ...
                .select-campaign-menu ::-webkit-scrollbar {
                    width: 10px;
                }

                /* Track */
                .select-campaign-menu ::-webkit-scrollbar-track {
                    background: #f1f1f1;
                }

                /* Handle */
                .select-campaign-menu ::-webkit-scrollbar-thumb {
                    background: #888;
                }
                ...
                /* Handle on hover */
                .select-campaign-menu ::-webkit-scrollbar-thumb:hover {
                    background: #555;
                }
            </style>
                ...
                <div class="d-flex mb-3">
                    <?php if (session()->get('tenant_id') == 1) { ?>
                        <select class="custom-select form-select custom-select-sm " aria-label="Default select example"
                            name="tenant" id="tenantchange" style="border-radius:10px;border:0px;width:250px;margin:0px 20px 0px 0px;font-size:12px">
                    ...
                    <div>
                        <select class="custom-select form-select custom-select-sm " aria-label="Default select example"
                            name="surveyId" id="surveyId"  style="border-radius:10px;border:0px;width:250px; font-size:12px">
