...
<section class="home">
  <div class="container">
    ...
    <form class="form-horizontal" action="<?= base_url('sendEmail') ?>" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 backgrd">
          <div id="dynamic_field" class="card border-canc">
            <div class="card-body send-cam">
            <?php if (isset($to)): ?>
              <div class="form-group mb-3">
                <div class="form-row row">
                  <label class="control-label  col-xl-3 col-lg-3 col-md-3" for="to">To</label>
                  <div class="col-xl-9 col-lg-9 col-md-9">
                    <input readonly type="text" class="form-control" style="height: 75px" id="to" placeholder="" name="to"
              ...
              <div class="form-group mb-3">
                <div class="form-row row">
                  <label class="control-label  col-xl-3 col-lg-3 col-md-3" for="From">From</label>
                  <div class="col-xl-9 col-lg-9 col-md-9">
                    <input type="text" class="form-control" id="from" placeholder="xxx@gmail.com" name="From"
                      autocomplete="off">
                    <?php if (isset($validation)): ?>
                      <div style="color:red">
              ...
              <div class="form-group mb-3">
                <div class="form-row row">
                  <label class="control-label  col-xl-3 col-lg-3 col-md-3" for="subject">subject</label>
                  <div class="col-xl-9 col-lg-9 col-md-9">
              ...
              <div class="form-group mb-3">
                <div class="form-row row">
                  <label class="control-label  col-xl-3 col-lg-3 col-md-3" for="Campaign Name">Survey /</br>
                    Campaign Name </label>
                  <div class="col-xl-9 col-lg-9 col-md-9">
            ...
            <div class="form-row row"> 
              ...
              <div class="form-group">
                <div class="form-row row">
                  <label class="control-label  col-xl-3 col-lg-3 col-md-3" for="From"></label>
                  <div class="col-xl-9 col-lg-9 col-md-9">
...
exit;
              ...
              <div class="form-group mt-4">
                <div class="form-row row">
                  <div class="col-md-6">
                    <input type="submit" name="submit" id="submit" class="btn btn-primary btn-block prw-mail"
                      value="Preview" />
                  </div>
                  <div class="col-md-6">
                    <input type="submit" name="submit" id="submit" class="btn btn-primary btn-block snd-mail"
                      value="Send Mail" />
                  </div>
                </div>
              </div>
                                ...
                                <div class="">
                                  <div class="row">
                                    ...
                                    <div class="customer-list-det">
                                      ...
                                      <input type="checkbox" id="checkoutemail" name="checkoutemail[]" <?php if (isset($to) && $to==$externalData["email_id"]): ?>checked <?php endif; ?>
                                        value="<?php echo $externalData["email_id"]; ?>" />
                                    </div>
                                  </div>
                                </div>
                              </li>
